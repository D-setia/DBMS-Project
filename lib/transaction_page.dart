...
class MakePayment extends StatefulWidget {
  ...
  final int _userId;
  MakePayment(this._amount, this._receiverName, this._balance, this._userId);
...
class _MakePaymentState extends State<MakePayment> {
  ...
  final Widget visaSvg =
      new SvgPicture.asset('assets/visaLogo.svg', semanticsLabel: 'Acme Logo');
                    ...
                    child: Card(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            padding:
                                const EdgeInsets.fromLTRB(20.0, 2.0, 2.0, 2.0),
                            child: Text(
                              "Payment Amount",
                              style: TextStyle(
                                fontWeight: FontWeight.w500,
                          ...
                          Padding(
                            padding:
                                const EdgeInsets.fromLTRB(20.0, 4.0, 2.0, 15.0),
                            child: Text(
                              "Rs. ${widget._amount}",
                              style: TextStyle(
                                  fontSize: 24.0,
